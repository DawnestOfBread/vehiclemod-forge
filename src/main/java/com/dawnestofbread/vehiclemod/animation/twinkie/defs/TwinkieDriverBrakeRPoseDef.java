...
public class TwinkieDriverBrakeRPoseDef extends PoseDefinition<Twinkie> {
    @Override
    public PlayerPose getPose(Player player, Twinkie vehicle) {
        double a = Math.signum(-vehicle.getWeightTransferX());
        Transform headT = new Transform().setPosition(0,0,-4.75).setRotation(42.5,0,0);
        Transform bodyT = new Transform().setPosition(0,0,-4.35).setRotation(25, 0, 0);
